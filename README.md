...
| --- | --- | --- |
| JsonApiFramework.Core | JsonApiFramework [Core] | 1.0.3-beta |
...
| Id | Name | Latest Version |
| --- | --- | --- |
| JsonApiFramework.Client | JsonApiFramework [Client] | 1.0.3-beta |
...
| Id | Name | Latest Version |
| --- | --- |--- |
| JsonApiFramework.Server | JsonApiFramework [Server] | 1.0.3-beta |
