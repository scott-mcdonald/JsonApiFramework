...
| --- | --- | --- |
| JsonApiFramework.Client | JsonApiFramework [Client] | 2.6.0 |
...
| Id | Name | Latest Version |
| --- | --- |--- |
| JsonApiFramework.Server | JsonApiFramework [Server] | 2.6.0 |
...
| Id | Name | Latest Version |
| --- | --- | --- |
| JsonApiFramework.Core | JsonApiFramework [Core] | 2.6.0 |
