...
public static class ExpressionBuilder
{
    ...
    public static Expression<Func<TObject, TResult>> MethodCall<TObject, TResult>(string methodName)
    {
        ...
        var methodInfo = JsonApiFramework.Reflection.TypeExtensions.GetMethod(objectType, methodName);
    ...
    public static Expression<Func<TResult>> StaticMethodCall<TClass, TResult>(string methodName)
    {
        ...
        var methodInfo = JsonApiFramework.Reflection.TypeExtensions.GetMethod(classType, methodName);
    ...
    public static LambdaExpression StaticPropertyGetter(Type classType, string propertyName)
    {
        ...
        var propertyInfo = JsonApiFramework.Reflection.TypeExtensions.GetProperty(classType, propertyName, BindingFlags.Public | BindingFlags.Static);
