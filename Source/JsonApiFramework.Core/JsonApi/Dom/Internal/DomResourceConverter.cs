...
{
    /// <summary>JSON.Net converter for DomResource nodes.</summary>
    internal class DomResourceConverter : DomNodeConverter
    {
        // PUBLIC CONSTRUCTORS //////////////////////////////////////////////
        #region Constructors
        public DomResourceConverter(DomJsonSerializerSettings domJsonSerializerSettings)
        ...
        public override bool CanConvert(Type objectType)
        {
            ...
            var canConvert = objectType == typeof(IDomResource) || objectType == typeof(DomResource);
            return canConvert;
        }
                ...
                case JsonToken.StartObject:
                    {
                        ...
                        var domResource = CreateDomResource(domReadJsonContext, jObject);
                ...
                default:
                    {
                        ...
                        var detail = "Expected JSON null or JSON object when reading JSON representing a json:api resource object.";
