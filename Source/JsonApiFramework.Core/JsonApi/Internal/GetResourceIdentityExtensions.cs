...
namespace JsonApiFramework.JsonApi.Internal
{
    ...
    internal static class GetResourceIdentityExtensions
    {
        ...
        {
            if (ReferenceEquals(getResourceIdentity, obj))
                return true;
        ...
        public static bool IsUndefined(this IGetResourceIdentity getResourceIdentity)
        {
            ...
            return String.IsNullOrWhiteSpace(getResourceIdentity?.Type) || String.IsNullOrWhiteSpace(getResourceIdentity.Id);
        }
        #endregion
    }
}
