...
namespace JsonApiFramework.JsonApi
{
    ...
    public static class JObjectExtensions
    {
        ...
        #region Methods
        /// <summary>
        /// Gets the json:api data type of a "data" json.net node which is
        /// typically either a resource or resource identifier.
        /// </summary>
        /// <param name="jObject">The "data" json.net node to get the json:api data type from.</param>
        /// <returns>Return a <see cref="DataType"/> enumeration representing the json:api data tyoe of a json.net "data" node.</returns>
        ...
        /// <summary>
        /// Gets the json:api document type of a json.net document.
        /// </summary>
        /// <param name="jObject">The json.net document to get the json:api document type from.</param>
        /// <returns>Return a <see cref="DocumentType"/> enumeration representing the json:api document tyoe of a json.net document.</returns>
        public static DocumentType GetDocumentType(this JObject jObject)
        {
            // Handle special case when JObject is null.
            if (jObject == null)
            {
                    ...
                    case JTokenType.Object:
                        {
                            ...
                            var dataJObjectDataType = dataJObject.GetDataType();
                    ...
                    case JTokenType.Array:
                        {
                            ...
                            var dataJArrayFirstJObjectDataType = dataJArrayFirstJObject.GetDataType();
