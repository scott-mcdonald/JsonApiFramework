...
namespace JsonApiFramework.TestData.ClrResources
{
    public static class ClrSampleData
    {
        ...
        // Home Relationships
        public static readonly IRelationshipInfo[] HomeRelationshipsInfoCollection =
        {
        };

        public static readonly IRelationshipsInfo HomeRelationshipsInfo = new RelationshipsInfo(HomeRelationshipsInfoCollection);
        ...
        public static readonly IRelationshipInfo[] SearchRelationshipsInfoCollection =
        {
        };

        public static readonly IRelationshipsInfo SearchRelationshipsInfo = new RelationshipsInfo(SearchRelationshipsInfoCollection);
        ...
        // Home Links
        public static readonly ILinkInfo HomeSelfLinkInfo = new LinkInfo(Keywords.Self);

        public static readonly ILinkInfo[] HomeLinksInfoCollection =
        {
            HomeSelfLinkInfo
        };

        public static readonly ILinksInfo HomeLinksInfo = new LinksInfo(typeof(Home), StaticReflection.GetMemberName<Home>(x => x.Links), HomeLinksInfoCollection);
        ...
        // Search Links
        public static readonly ILinkInfo SearchSelfLinkInfo = new LinkInfo(Keywords.Self);

        public static readonly ILinkInfo[] SearchLinksInfoCollection =
        {
            SearchSelfLinkInfo
        };

        public static readonly ILinksInfo SearchLinksInfo = new LinksInfo(typeof(Search), StaticReflection.GetMemberName<Search>(x => x.Links), SearchLinksInfoCollection);
        ...
        public static readonly IResourceType HomeResourceType               = new ResourceType(HomeClrType,               HomeHypermediaInfo,               HomeResourceIdentityInfo,               HomeAttributesInfo,               HomeRelationshipsInfo,               HomeLinksInfo,               null);
