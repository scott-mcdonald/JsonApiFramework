                ...
                new object[]
                    {
                        "WithNull", new IConvertTest[]
                            {
                                new ConvertTest<bool>(null, true, default(bool)),
                                new ConvertTest<byte>(null, true, default(byte)),
                                new ConvertTest<char>(null, true, default(char)),
                                new ConvertTest<DateTime>(null, true, default(DateTime)),
                                new ConvertTest<decimal>(null, true, default(decimal)),
                                new ConvertTest<double>(null, true, default(double)),
                                new ConvertTest<float>(null, true, default(float)),
                                new ConvertTest<int>(null, true, default(int)),
                                new ConvertTest<long>(null, true, default(long)),
                                new ConvertTest<sbyte>(null, true, default(sbyte)),
                                new ConvertTest<short>(null, true, default(short)),
                                new ConvertTest<string>(null, true, default(string)),
                                new ConvertTest<uint>(null, true, default(uint)),
                                new ConvertTest<ulong>(null, true, default(ulong)),
