        ...
        public static void MyMethod()
        {
            var resourceDocument = new DocumentContext(default(IDocumentContextOptions))
                .NewDocument(String.Empty)
                    ...
                    .ResourceEnd()
                    .Included()
                        .Include(RelatedResource.Create(SampleArticles.Article, ApiSampleData.ArticleToAuthorRel, SamplePersons.Person))
                            .SetMeta(ApiSampleData.ResourceMeta)
                            .Relationships()
                        ...
                        .Include(RelatedResources.Create(SampleArticles.Article, ApiSampleData.ArticleToCommentsRel, new[] { SampleComments.Comment1, SampleComments.Comment2 }))
                            .SetMeta(ApiSampleData.ResourceMeta)
                            .Relationships()
                ...
                new object[]
                    {
                        ...
                        DocumentBuilderFactory.Create(ClrSampleData.ServiceModelWithBlogResourceTypes, HypermediaAssemblerRegistry, UrlBuilderConfigurationWithoutRootPathSegments, ApiSampleData.ArticleCollectionHRef)
                            ...
                            .ResourceCollectionEnd()
                            .Included()
                                .Include(RelatedResource.Create(SampleArticles.Article1, ApiSampleData.ArticleToAuthorRel, SamplePersons.Person1),
                                         RelatedResource.Create(SampleArticles.Article2, ApiSampleData.ArticleToAuthorRel, SamplePersons.Person2))
                                    .SetMeta(ApiSampleData.ResourceMeta)
                                    .Relationships()
                                    ...
                                    .LinksEnd()
                                .IncludeEnd()
                                .Include(RelatedResources.Create(SampleArticles.Article1, ApiSampleData.ArticleToCommentsRel, SampleComments.Comment1, SampleComments.Comment2),
                                         RelatedResources.Create(SampleArticles.Article2, ApiSampleData.ArticleToCommentsRel, SampleComments.Comment3, SampleComments.Comment4))
                ...
                new object[]
                    {
                        ...
                        DocumentBuilderFactory.Create(ClrSampleData.ServiceModelWithBlogResourceTypes, HypermediaAssemblerRegistry, UrlBuilderConfigurationWithoutRootPathSegments, ApiSampleData.ArticleCollectionHRef)
                            ...
                            .Included()
                                .Include(RelatedResource.Create(SampleArticles.Article1, ApiSampleData.ArticleToAuthorRel, SamplePersons.Person1),
                                         RelatedResource.Create(SampleArticles.Article2, ApiSampleData.ArticleToAuthorRel, SamplePersons.Person1))
                                    .SetMeta(ApiSampleData.ResourceMeta)
                                    .Relationships()
                                        .AddRelationship(ApiSampleData.PersonToCommentsRel, Keywords.Self, Keywords.Related)
                                    .RelationshipsEnd()
                                    ...
                                    .LinksEnd()
                                .IncludeEnd()
                                .Include(RelatedResources.Create(SampleArticles.Article1, ApiSampleData.ArticleToCommentsRel, new [] { SampleComments.Comment1 }),
                                         RelatedResources.Create(SampleArticles.Article2, ApiSampleData.ArticleToCommentsRel, new [] { SampleComments.Comment1 }))
                                    ...
                                    .LinksEnd()
                                .IncludeEnd()
                                .Include(RelatedResources.Create(SampleArticles.Article1, ApiSampleData.ArticleToCommentsRel, new [] { SampleComments.Comment2 }),
                                         RelatedResources.Create(SampleArticles.Article2, ApiSampleData.ArticleToCommentsRel, new [] { SampleComments.Comment2 }))
                        ...
                        DocumentBuilderFactory.Create(ClrSampleData.ServiceModelWithBlogResourceTypes, HypermediaAssemblerRegistry, UrlBuilderConfigurationWithoutRootPathSegments, ApiSampleData.ArticleHRef)
                            ...
                            .Included()
                                ...
                                .Include(RelatedResource.Create(SampleArticles.Article, ApiSampleData.ArticleToAuthorRel, SamplePersons.Person))
                                    ...
                                    .LinksEnd()
                                .IncludeEnd()
                                .Include(RelatedResources.Create(SampleArticles.Article, ApiSampleData.ArticleToCommentsRel, new[]{ SampleComments.Comment1 }))
                                    .SetMeta(ApiSampleData.ResourceMeta)
                                    .Relationships()
                                        .AddRelationship(ApiSampleData.CommentToAuthorRel, Keywords.Self, Keywords.Related)
                                    .RelationshipsEnd()
                ...
                new object[]
                    {
                        ...
                        DocumentBuilderFactory.Create(ClrSampleData.ServiceModelWithOrderResourceTypes, HypermediaAssemblerRegistry, UrlBuilderConfigurationWithoutRootPathSegments, "http://api.example.com/en-us/orders/1")
                            ...
                            .ResourceEnd()
                            .Included()
                                .Include(RelatedResources.Create(SampleOrders.Order, ClrSampleData.OrderToOrderItemsRel, SampleOrderItems.OrderItem1001, SampleOrderItems.OrderItem1002))
                                    .Paths()
                                        .AddPath("en-us")
                                        .AddPath(SampleOrders.Order, ClrSampleData.OrderToOrderItemsRel)
                                    .PathsEnd()
                                    ...
                                    .LinksEnd()
                                .IncludeEnd()
                                .Include(RelatedResources.Create(SampleOrders.Order, ClrSampleData.OrderToPaymentsRel, SamplePayments.Payment101, SamplePayments.Payment102))
                                    .Paths()
                                        .AddPath("en-us")
                                    .PathsEnd()
                                    .Relationships()
                                    ...
                                    .LinksEnd()
                                .IncludeEnd()
                                .Include(RelatedResource.Create(SampleOrders.Order, ClrSampleData.OrderToStoreRel, SampleStores.Store50))
                                    .Paths()
                                        .AddPath("en-us")
                                    .PathsEnd()
                                    .Relationships()
                                ...
                                .AddInclude(RelatedResource.Create(SampleOrderItems.OrderItem1001, ClrSampleData.OrderItemToOrderRel, SampleOrders.Order),
                                            RelatedResource.Create(SampleOrderItems.OrderItem1002, ClrSampleData.OrderItemToOrderRel, SampleOrders.Order))
                                .AddInclude(RelatedResource.Create(SamplePayments.Payment101, ClrSampleData.PaymentToOrderRel, SampleOrders.Order),
                                            RelatedResource.Create(SamplePayments.Payment102, ClrSampleData.PaymentToOrderRel, SampleOrders.Order))

                                .Include(RelatedResource.Create(SampleOrderItems.OrderItem1001, ClrSampleData.OrderItemToProductRel, SampleProducts.Product501))
                                    .Paths()
                                        .AddPath("en-us")
                                    .PathsEnd()
                                    .Links()
                                ...
                                .Include(RelatedResource.Create(SampleOrderItems.OrderItem1002, ClrSampleData.OrderItemToProductRel, SampleProducts.Product502))
                                    .Paths()
                                        .AddPath("en-us")
                                    .PathsEnd()
                                    .Links()
                                ...
                                .Include(RelatedResource.Create(SampleStores.Store50, ClrSampleData.StoreToStoreConfigurationRel, SampleStoreConfigurations.Store50Configuration))
                                    .Paths()
                                        .AddPath("en-us")
                                ...
                                .Include(RelatedResource.Create(SampleStoreConfigurations.Store50Configuration, ClrSampleData.StoreToStoreConfigurationToPosSystemRel, SamplePosSystems.PosSystemRadiantWcf))
                                    .Paths()
                                        .AddPath("en-us")
                                    .PathsEnd()
                                    .Relationships()
                ...
                new object[]
                    {
                        ...
                        DocumentBuilderFactory.Create(ClrSampleData.ServiceModelWithOrderResourceTypes, HypermediaAssemblerRegistry, UrlBuilderConfigurationWithoutRootPathSegments, "http://api.example.com/orders/1")
                            ...
                            .ResourceEnd()
                            .Included()
                                .Include(RelatedResources.Create(SampleOrders.Order, ClrSampleData.OrderToPaymentsRel, default(IEnumerable<Payment>)))
                                    .Relationships()
                                        .AddRelationship(ClrSampleData.PaymentToOrderRel, Keywords.Self, Keywords.Related)
                                    .RelationshipsEnd()
                                    .Links()
                ...
                new object[]
                    {
                        ...
                        DocumentBuilderFactory.Create(ClrSampleData.ServiceModelWithOrderResourceTypes, HypermediaAssemblerRegistry, UrlBuilderConfigurationWithoutRootPathSegments, "http://api.example.com/orders/1")
                            ...
                            .ResourceEnd()
                            .Included()
                                .Include(RelatedResource.Create(SampleOrders.Order, ClrSampleData.OrderToStoreRel, default(Store)))
                                    .Relationships()
                                        .AddRelationship(ClrSampleData.StoreToStoreConfigurationRel, Keywords.Self, Keywords.Related)
                                    .RelationshipsEnd()
                                    .Links()
